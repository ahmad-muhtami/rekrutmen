<div class="container-fluid p-4 h-100 bg-white">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <h1 class="h4 text-gray-800">Laporan Rekrutmen & Seleksi Karyawan <span class="d-block font-weight-normal" style="font-size: 14px;">Cetak data laporan</span></h1>
    <div class="d-flex justify-content-end">
      <div>
        <a href="laporan-rekrutmen.php?page=cetak" class="btn btn-danger" target="_blank"><i class="fas fa-file-pdf"></i> Cetak</a>
          ...
          <tbody>
            ...
            $query = "
              SELECT 
                  ...
                  bidang_pekerjaan.jenis_pekerjaan AS jenis
              FROM rekrutmen
              JOIN pengguna 
            ...
            ?>
              <tr>
                <td><?= $no++; ?></td>
                <td class="text-capitalize"><?= $row['nama_pelamar']; ?></td>
                <td><?= $row['usia']; ?></td>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="laporan-rekrutmen.php?page=export" method="get" id="print" target="_blank">
