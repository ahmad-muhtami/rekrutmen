...
<div class="container-fluid h-100 p-4 bg-white">
  ...
  <div class="d-flex align-items-center justify-content-between mb-4">
    <h1 class="h4 text-gray-800">Data Rekrutmen & Seleksi</h1>
...
JOIN bidang_pekerjaan 
    ...
    WHERE rekrutmen.pelamar_id = $user_id
...
";
            ...
            ?>
              <tr>
                ...
                <td class="text-nowrap text-capitalize"><?= $row['nama_pelamar']; ?></td>
                <td class="text-nowrap text-capitalize"><?= $row['nama_bidang']; ?></td>
                <td class="text-nowrap"><?= format_date($row['tanggal']); ?></td>
                <td class="text-nowrap"><?= $row['email']; ?></td>
                <td class="text-nowrap text-capitalize"><?= $row['status']; ?></td>
                <td><?= $row['catatan']; ?></td>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="col-12 pt-3">
                          ...
                          <div class="">
                            <a href="./uploads/<?= $row['cv']; ?>" class="btn btn-outline-primary d-block w-100 text-left mb-2" target="_blank"><?= $row['cv']; ?></a>
                            ...
                            <?php while ($lampiran = mysqli_fetch_assoc($lampiran_result)) { ?>
                              <a href="./uploads/<?= $lampiran['lampiran']; ?>" class="btn btn-outline-primary d-block w-100 text-left mb-2" target="_blank"><?= $lampiran['lampiran']; ?></a>
                            <?php } ?>
                          </div>
                        </div>
                      </div>
